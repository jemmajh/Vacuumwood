...
@import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@400;500&family=Barlow+Condensed:wght@700&family=Syne:wght@400;600;700;800&display=swap');
  ...
  /* section headers */
  .section-header { font-size:18px; font-weight:700; color:#000; border-bottom:2.5px solid #3CB371;
                    padding-bottom:6px; margin:1.4rem 0 1rem; letter-spacing:0.5px; }

  /* tab override */
  div[data-testid="stTabs"] button { font-weight:600; font-size:15px; letter-spacing:0.4px; }
  div[data-testid="stTabs"] button[aria-selected="true"] { color: #3CB371 !important; }

  /* number inputs */
  div[data-testid="stNumberInput"] label { font-size:13px; font-weight:600; color:#444; }

  /* info box */
  .info-box { background:#f0f7f4; border-left:4px solid #3CB371; padding:0.8rem 1rem;
              border-radius:0 8px 8px 0; font-size:14px; color:#2a5a40; margin:0.6rem 0; }

  /* strategy bar highlight */
  .best-strategy { background:#e6f5ed; border:2px solid #3CB371; border-radius:10px; padding:0.8rem 1rem; }
  </style>
...
#  TABS
tab1, tab2 = st.tabs([
    "️Farm & Financial Model",
    "Electricity & Strategy Optimisation",
])
...
with tab2:
    ...
    #STRATEGY COMPARISON (interactive)
